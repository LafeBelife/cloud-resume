...
$(function() {
	(function() {
		console.log('Hi! 朋友，感谢您愿意调试简历代码。n如果您有什么建议或者想学习前端，欢迎您加入我们,我们互相学习，共同进步^_^。nQQ小群(https://jq.qq.com/?_wv=1027&k=4EC0LCk)');

//console.log('查看源码：(https://mp.weixin.qq.com/s/tlsXy-lwFn4pZ-1onWQKYg)');
console.log('获取简历源码：(http://www.2019w.cn)');
